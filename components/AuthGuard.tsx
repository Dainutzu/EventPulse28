...
import { Mail, Zap, Sparkles, ShieldCheck } from "lucide-react";
...
export default function AuthGuard({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="fixed inset-0 z-[1000] bg-white dark:bg-neutral-900 flex flex-col items-center justify-center px-8 overflow-hidden">
      {/* Background glow for premium feel */}
      <div className="absolute top-1/4 -left-10 w-96 h-96 bg-blue-500/10 dark:bg-blue-500/5 blur-[120px] rounded-full" />
      <div className="absolute bottom-1/4 -right-10 w-96 h-96 bg-purple-500/20 dark:bg-purple-500/10 blur-[140px] rounded-full" />
      ...
      >
        ...
        <p className="text-lg font-bold text-neutral-500 dark:text-neutral-400 tracking-tight uppercase px-4">
      ...
      >
        <button
          onClick={signIn}
          className="group relative flex items-center justify-center gap-3 w-full py-5 rounded-[2rem] bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 font-black text-base shadow-[0_20px_50px_rgba(0,0,0,0.15)] active:scale-95 transition-all overflow-hidden"
        >
        ...
        <p className="text-[10px] text-center font-black text-neutral-400 uppercase tracking-widest px-8 leading-relaxed">
          Access your secured campus network and student events.
        </p>
      </motion.div>
